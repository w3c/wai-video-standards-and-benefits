...
* {% include link.html to="/perspectives/" text="**Видео о перспективах доступности веб-сайтов**: Узнайте о влиянии и преимуществах для всех"%} — видео и информация по отдельным темам доступности.
